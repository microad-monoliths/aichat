...
/**
 * AiChat SharedPreference Utility Class.
 */
...
public class SharedPreferenceUtils {
    ...
    /**
     * Stores ArrayList value in preference
     *
     * @param key   key of preference
     * @param value value for that key
     */
    ...
    /**
     * Retrieves ArrayList<String></String> value from preference
     *
     * @param key          key of preference
     * @param defaultValue default value if no key found
     * @return
     */
    public ArrayList<String> getArrayStringValue(String key, Set<String> defaultValue) {
        return new ArrayList<>(mSharedPreferences.getStringSet(key, defaultValue));
    }
    ...
    public boolean checkKey(String keyFlag) {
        return mSharedPreferences.contains(keyFlag);
    }
}
